...
/**
 * Class CrFieldService.
 */
class CrFieldService extends BaseService
{
    /**
     * CrFieldService constructor.
     *
     * @param  CrField  $crField
     */
     ...
     * @throws \Throwable
     */
    public function store(array $data = []): CrField
    {
        DB::beginTransaction();
        ...
        try {
            ...
            if ($form) {
                ...
                $this->createFieldAfterSave($data['slug']);
            }
        } catch (Exception $e) {
            DB::rollBack(); 
